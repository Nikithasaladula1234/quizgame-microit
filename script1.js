  ...
  <header>
    ...
    <div class="scrolling-text">
      <marquee behavior="scroll" direction="left">
        "Push yourself, because no one else is going to do it for you." | "Don’t watch the clock; do what it does. Keep going." | "Great thi…
[1:25 PM, 6/6/2025] meghana: let currentQuiz = [];
let currentIndex = 0;
let score = 0;
